 ...
 */
public class MPPProductBOM extends LP_PP_Product_BOM
{
	...
	public static final Object BOMTYPE_Make_To_Order = null;
	public static final Object BOMTYPE_Make_To_Kit = null;
	public static final Object BOMUSE_Manufacturing = null;
	/**	Cache						*/
	...
	public static List<MPPProductBOM> getProductBOMs(MProduct product)
	{
		...
		return new Query (product.getCtx(), LP_PP_Product_BOM.Table_Name, whereClause, product.get_TrxName())
					.setClient_ID()
