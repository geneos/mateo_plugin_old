...
public class LP_PP_Order_Node extends org.openXpertya.model.PO {
	...
	public LP_PP_Order_Node(Properties ctx, int PP_Order_Node_ID, String trxName) {
		...
		/**
		 * if (PP_Order_Node_ID == 0) { setAction (null); // Z setAD_WF_Node_ID
		 * (0); setAD_Workflow_ID (0); setCost (Env.ZERO); setEntityType (0); //
		 * U setIsCentrallyMaintained (false); setJoinElement (null); // X
		 * setlimit_time (0); setName (null); setPP_Order_ID (0);
		 * setPP_Order_Node_ID (0); setPP_Order_Workflow_ID (0); setPriority
		 * (0); setSplitElement (null); // X setValue (null); setWaitingTime
		 * (0); setWorkingTime (0); setXPosition (0); setYPosition (0); }
		 */
	}
	...
	public void setAction(String Action) {
		if (Action.equals("C") || Action.equals("R") || Action.equals("P") || Action.equals("B") || Action.equals("T") || Action.equals("D")
				|| Action.equals("X") || Action.equals("Z") || Action.equals("F") || Action.equals("V") || Action.equals("W"))
			;
		else
			throw new IllegalArgumentException("Action Invalid value - Reference = ACTION_AD_Reference_ID - C - R - P - B - T - D - X - Z - F - V - W");
		if (Action == null)
	...
	public void setDocAction(String DocAction) {
		if (DocAction == null || DocAction.equals("AP") || DocAction.equals("CL") || DocAction.equals("PR") || DocAction.equals("IN") || DocAction.equals("CO")
	...
	public void setEntityType(String string) {
		set_Value("EntityType", new String(string));
	}
	...
	public void setFinishMode(String FinishMode) {
		if (FinishMode == null || FinishMode.equals("A") || FinishMode.equals("M"))
			...
			throw new IllegalArgumentException("FinishMode Invalid value - Reference = FINISHMODE_AD_Reference_ID - A - M");
	...
	public void setJoinElement(String JoinElement) {
		if (JoinElement.equals("A") || JoinElement.equals("X"))
			...
			throw new IllegalArgumentException("JoinElement Invalid value - Reference = JOINELEMENT_AD_Reference_ID - A - X");
		if (JoinElement == null)
	...
	public void setSplitElement(String SplitElement) {
		if (SplitElement.equals("A") || SplitElement.equals("X"))
			...
			throw new IllegalArgumentException("SplitElement Invalid value - Reference = SPLITELEMENT_AD_Reference_ID - A - X");
	...
	public void setStartMode(String StartMode) {
		if (StartMode == null || StartMode.equals("A") || StartMode.equals("M"))
			...
			throw new IllegalArgumentException("StartMode Invalid value - Reference = STARTMODE_AD_Reference_ID - A - M");
	...
	public void setSubflowExecution(String SubflowExecution) {
		if (SubflowExecution == null || SubflowExecution.equals("A") || SubflowExecution.equals("S"))
			...
			throw new IllegalArgumentException("SubflowExecution Invalid value - Reference = SUBFLOWEXECUTION_AD_Reference_ID - A - S");
