...
/** Modelo Generado por PP_Product_BOM
 *  @author Comunidad de Desarrollo Libertya*         *Basado en Codigo Original Modificado, Revisado y Optimizado de:*         * Jorg Janke 
 *  @version  - 2015-05-06 07:39:01.01 */
public class LP_PP_Product_BOM extends org.openXpertya.model.PO
{
/** Constructor estándar */
public LP_PP_Product_BOM (Properties ctx, int PP_Product_BOM_ID, String trxName)
{
...
/** Load Constructor */
public LP_PP_Product_BOM (Properties ctx, ResultSet rs, String trxName)
{
super (ctx, rs, trxName);
}
/** AD_Table_ID */
public static final int Table_ID = M_Table.getTableID("PP_Product_BOM");

/** TableName=PP_Product_BOM */
public static final String Table_Name="PP_Product_BOM";

protected static KeyNamePair Model = new KeyNamePair(Table_ID,"PP_Product_BOM");
...
{
StringBuffer sb = new StringBuffer ("LP_PP_Product_BOM[").append(getID()).append("]");
return sb.toString();
}
...
{
if (BOMType == null || BOMType.equals("M") || BOMType.equals("R") || BOMType.equals("A") || BOMType.equals("O") || BOMType.equals("P") || BOMType.equals("S") || BOMType.equals("F") || BOMType.equals("C") || BOMType.equals("K"));
 else throw new IllegalArgumentException ("BOMType Invalid value - Reference = BOMTYPE_AD_Reference_ID - M - R - A - O - P - S - F - C - K");
...
if (BOMUse == null || BOMUse.equals("A") || BOMUse.equals("E") || BOMUse.equals("M") || BOMUse.equals("P") || BOMUse.equals("Q"));
 else throw new IllegalArgumentException ("BOMUse Invalid value - Reference = BOMUSE_AD_Reference_ID - A - E - M - P - Q");
...
{
set_ValueNoCheck ("PP_Product_Bom_ID", new Integer(PP_Product_Bom_ID));
}
